...
function MobileVariant({ image, eyebrow, headline, paragraph, children }: Props) {
  ...
  return (
    <section
      ref={wrap}
      className="relative h-[90dvh] min-h-[560px] w-full overflow-hidden bg-forest-900"
    >
      ...
      <div className="relative z-10 flex h-full items-end p-6 pb-14">
        <div className="text-ivory-50">
          <p className="eyebrow text-gold-300">{eyebrow}</p>
          <h2 className="mt-4 font-serif text-[clamp(2rem,9vw,3rem)] leading-[1.05] tracking-brand-tight">
            {headline}
          </h2>
          <p className="mt-4 max-w-lg text-[15px] leading-relaxed text-ivory-100/90">
            {paragraph}
          </p>
